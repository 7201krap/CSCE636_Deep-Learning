...
def parse_record(record, training):
    ...
    # I will use 32x32x3 format.
    # Therefore, I transposed it from (3, 32, 32) to (32, 32, 3)
    ...
    ** IMPORTANT_NOTE: End **
    ...
    if training:
        transform_image = transforms.Compose([
            ...
            transforms.ToTensor(),
            # For normalizing constant, see: https://github.com/kuangliu/pytorch-cifar/issues/19
